    ...
    public partial class adminmodel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Description for Job1", 0, 1, 500m, 100m, new DateTime(2024, 6, 1, 17, 47, 31, 830, DateTimeKind.Local).AddTicks(9217), "Job1" },
                    { 2, 2, 2, "Description for Job2", 1, 2, 700m, 200m, new DateTime(2024, 6, 1, 17, 47, 31, 830, DateTimeKind.Local).AddTicks(9282), "Job2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Description for Project1", 1, null, null, null, "Project1" },
                    { 2, "Description for Project2", 2, null, null, null, "Project2" }
                });
