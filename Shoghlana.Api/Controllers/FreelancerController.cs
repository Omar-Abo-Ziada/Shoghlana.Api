...
namespace Shoghlana.Api.Controllers
{
    ...
    public class FreelancerController : ControllerBase
    {
        ...
        public FreelancerController(IMapper mapper, IFreelancerService freelancerService)
        {
            this.mapper = mapper;
        ...
        {
            List<Freelancer> freelancers = freelancerService.FindAll(includes: ["Skills"]).ToList();
        ...
        {
            Freelancer? freelancer = freelancerService.Find(criteria: null, includes: ["Skills"]);
        ...
        public async Task<ActionResult<GeneralResponse>> AddAsync([FromForm] AddFreelancerDTO addedFreelancerDTO)
        {
            ...
            Freelancer addedFreelancer = await freelancerService.AddAsync(freelancer);

            freelancerService.Save();
